...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblStationImage.setStyleSheet("border: 2px solid #cccccc;")
...
"")
        ...
        self.sliderVolume = QtWidgets.QSlider(self.widget)
        ...
        self.sliderVolume.setMinimumSize(QtCore.QSize(400, 20))
        self.sliderVolume.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.sliderVolume.setAutoFillBackground(False)
        ...
        self.horizontalLayout_2.addWidget(self.btnFav)
...
"background-color: #ebebeb;")
        self.twStationList.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.twStationList.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.twStationList.setAlternatingRowColors(False)
